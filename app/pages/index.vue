...
<template>
  <div class="min-h-screen bg-cream-50">
    ...
    <div id="osis">
      ...
      <!-- BPH OSIS -->
      <SectionsOsisBPHSection :members="osisBPH" />

      <!-- Sekbid 1-6 -->
      <SectionsOsisSekbidSection
        v-for="sekbid in sekbidData"
    ...
    <div id="ekskul">
      ...
      <SectionsEkskulSection
        v-for="ekskul in ekskulData"
        :key="ekskul.ekskulName"
